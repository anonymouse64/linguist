...
class TestLanguage < Minitest::Test
  ...
  def test_find_by_extension
    ...
    assert_equal [Language['Limbo'], Language['M'], Language['MUF'], Language['WolframLanguage'], Language['Matlab'], Language['Mercury'], Language['Objective-C']], Language.find_by_extension('foo.m')
